...
getInitialState: function getInitialState() {return this.generateCalendar();},
...
handleImage: function handleImage(e) {var _this = this;
 e.preventDefault();
                 ...
                 React.createElement('div', { className: 'entry_details' },
                     React.createElement('div', null,
                         React.createElement('div', { className: 'entry_info first' },
                             ...
                             React.createElement('input', { type: 'file', name: 'entry-img', id: 'entry-img', onChange: function onChange(e) {return _this2.handleImage(e);} }),
